...
app.post('/', (req,res) => {        
    ...
    if(searchTerm!=''){
        var apiUrl = `http://ieeexploreapi.ieee.org/api/v1/search/articles?apikey=9bhdjqu9tzebjdm5xjr9p6xw&format=json&max_records=20&start_record=1&sort_order=asc&sort_field=article_number&abstract=${searchTerm}`
